...
public class ReloadConfigCommand implements CommandExecutor {
    ...
    public boolean onCommand( CommandSender sender, Command command, String label, String[] args) {
        ...
        String newLanguage = SimplePin.getInstance().getConfig().getString("lang");
        ...
        plugin.getServer().getLogger().info("[SimplePin] The plugin config was successfully reloaded");
